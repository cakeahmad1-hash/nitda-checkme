...
const AdminDashboard: React.FC<{ onLogout: () => void; db: MockDb }> = ({ onLogout, db }) => {
    ...
    const filteredInternLogs = React.useMemo(() => {
        ...
        // Note: Status filter is intentionally removed for intern view as it's not applicable.
                    ...
                    <div className="flex flex-wrap items-center justify-between p-4 border-b border-gray-700 gap-4">
                     ...
                     <div className="overflow-x-auto">
                         <table className="w-full min-w-[1000px] text-sm text-left text-gray-300">
                            ...
                            <tbody>
                                {isLoading ? (
                                    <tr><td colSpan={view === 'logs' ? 11 : 4} className="text-center p-8"><Spinner /></td></tr>
