...
const AdminDashboard: React.FC<{ onLogout: () => void; db: MockDb }> = ({ onLogout, db }) => {
    ...
    const handleUpdateLogSubmit = async (e: React.FormEvent) => {
        ...
        if (!editFormData.name.trim() || !editFormData.department.trim()) {
        ...
        <div className="container mx-auto p-4 sm:p-6 lg:p-8">
            ...
            <Modal isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} title="Edit Visitor Log" size="lg">
                <form onSubmit={handleUpdateLogSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                         <div>
                            <label htmlFor="edit-laptopName" className="block text-sm font-medium text-gray-300 mb-1">Laptop Name</label>
                            <Input id="edit-laptopName" name="laptopName" placeholder="e.g., HP EliteBook" value={editFormData.laptopName} onChange={handleEditFormChange} />
                        </div>
                        <div>
                           <label htmlFor="edit-laptopColor" className="block text-sm font-medium text-gray-300 mb-1">Laptop Colour</label>
                            <Input id="edit-laptopColor" name="laptopColor" placeholder="e.g., Silver" value={editFormData.laptopColor} onChange={handleEditFormChange} />
                        </div>
                         <div>
                           <label htmlFor="edit-serialNumber" className="block text-sm font-medium text-gray-300 mb-1">Serial Number</label>
                            <Input id="edit-serialNumber" name="serialNumber" placeholder="Serial Number" value={editFormData.serialNumber} onChange={handleEditFormChange} />
                        </div>
                    </div>
